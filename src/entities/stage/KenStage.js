...
import { BackgroundAnimation } from "./shared/BackgroundAnimations.js";
...
export class KenStage{
    ...
    constructor(){
        ...
        this.floor = new Floor(this.image, [8,392,896,56]);
        
        // order matters, first background sea boat, stage boat and then stage floor and miscellaneous
        this.frames = new Map([
